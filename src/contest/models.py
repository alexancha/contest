...
class Mootcourt(models.Model):
    ...
    tags = models.ManyToManyField(Tag, null=True, blank=True, limit_choices_to={'tags__count__lt': 50}, verbose_name=_('Tags'))
    ...
    telegram_channel = models.ForeignKey('Channel', on_delete=models.SET_NULL, verbose_name=_('Telegram Channel'))
    teams = models.ManyToManyField(Team, null=True, blank=True, verbose_name=_('Teams'))
    senior_referees = models.ManyToManyField(Profile, related_name='senior_arbiters',
                                             blank=True, verbose_name=_('Senior referees'))
    referees = models.ManyToManyField(Profile, related_name='arbiters', null=True, blank=True, verbose_name=_('Referees'))
